---
title: "gpui"
source: "https://www.gpui.rs/"
author:
published:
created: 2025-12-05
description: "A fast, productive UI framework for Rust from the creators of Zed."
tags:
  - "clippings"
---
## A fast, productive UI framework for Rust from the creators of Zed.

[Get Started →](https://github.com/zed-industries/zed/tree/main/crates/gpui)
...
gpui is an open source project. We welcome contributions, but for the near future gpui is tied to [Zed](https://zed.dev/), so contributions will need to be made there and kept in sync with it.